...
def normalize_frequency(tokens):
    ...
    '''
    remove_head = '0123456789abcdefghijklmnopqrstuvwxyz것/+'
    remove_target = ['밝혔다', '말했다', '지난', '이라', '따르면', '중이다', '알려졌다', '뉴시스', '정확한', '드러', '이미지', '한경닷컴',
    ...
    for t in tokens.keys():
        if t[0] in remove_head or t in remove_target or t[-2:] in remove_tail:
